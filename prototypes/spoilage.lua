...
ITEM { -- todo: Allow composting
    type = "item",
    name = "biocarnation",
    icon = "__pyhardmode__/graphics/icons/biocarnation.png",
    icon_size = 64,
...
ITEM("sodium-citrate"):spoil("water-barrel", 4 * hour)
RECIPE("metallic-core")
:add_result {type = "item", name = "barrel", amount = 5, ignored_by_stats = 5, ignored_by_productivity = 5}
.main_product = "metallic-core"

ITEM {
    type = "item",
    name = "biocrud",
    icon = "__pyhardmode__/graphics/icons/mip/biocrud-1.png",
    icon_size = 64,

    pictures = {
        {size = 64, filename = "__pyhardmode__/graphics/icons/mip/biocrud-1.png", scale = 0.60},
        {size = 64, filename = "__pyhardmode__/graphics/icons/mip/biocrud-2.png", scale = 0.60},
        {size = 48, filename = "__pyhardmode__/graphics/icons/mip/biocrud-3.png", scale = 0.60},
        {size = 48, filename = "__pyhardmode__/graphics/icons/mip/biocrud-4.png", scale = 0.60},
    },
    flags = {},
    subgroup = "py-alienlife-items",
    order = "ga",
...
ITEM {
    type = "item",
    name = "rich-biocrud",
    icon = "__pyhardmode__/graphics/icons/mip/rich-biocrud-1.png",
    icon_size = 64,

    pictures = {
        {size = 64, filename = "__pyhardmode__/graphics/icons/mip/rich-biocrud-1.png", scale = 0.60},
        {size = 64, filename = "__pyhardmode__/graphics/icons/mip/rich-biocrud-2.png", scale = 0.60},
        {size = 48, filename = "__pyhardmode__/graphics/icons/mip/rich-biocrud-3.png", scale = 0.60},
        {size = 48, filename = "__pyhardmode__/graphics/icons/mip/rich-biocrud-4.png", scale = 0.60},
    },
    flags = {},
    subgroup = "py-alienlife-items",
    order = "ga",
...
RECIPE {
    ...
    icons = {
        {
            icon = "__pyhardmode__/graphics/icons/recycling.png"
        },
        {
            icon = "__pyhardmode__/graphics/icons/mip/biocrud-1.png",
            scale = 0.4
        ...
        {
            icon = "__pyhardmode__/graphics/icons/recycling-top.png"
        }
    },
    icon_size = 64,
    subgroup = "py-alienlife-items",
...
ITEM("carbon-aerogel"):spoil("aerogel", 50 * minute)
